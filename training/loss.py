...
def G_logistic_nonsaturating(G_A2B, G_B2A, F, D_A, D_B, opt, reals_image_A, reals_feat_B,
    ...
    fake_feat_B = G_A2B.get_output_for(real_feat_A, labels, is_training=True)
    fake_feat_A_return = G_B2A.get_output_for(fake_feat_B, labels, is_training=True)
    fake_feat_B_score = fp32(D_B.get_output_for(fake_feat_B, labels, is_training=True))
    ...
    # B2A2B
    fake_feat_A = G_B2A.get_output_for(reals_feat_B, labels, is_training=True)
    fake_feat_B_return = G_A2B.get_output_for(fake_feat_A, labels, is_training=True)
    fake_feat_A_score = fp32(D_A.get_output_for(fake_feat_A, labels, is_training=True))
...
def D_logistic_simplegp(G_A2B, G_B2A, F, D_A, D_B, opt,
                        reals_image_A, reals_feat_B, labels_A, labels_B,
    ...
    # A2B
    real_feat_A = F.get_output_for(reals_image_A, is_training=True)
    fake_feat_B = G_A2B.get_output_for(real_feat_A, labels_A, is_training=True)
    loss_A2B_real = fp32(D_B.get_output_for(reals_feat_B, labels_B, is_training=True))
    loss_A2B_fake = fp32(D_B.get_output_for(fake_feat_B, labels_B, is_training=True))
    ...
    # B2A
    fake_feat_A = G_B2A.get_output_for(reals_feat_B, labels_B, is_training=True)
    loss_B2A_real = fp32(D_A.get_output_for(real_feat_A, labels_A, is_training=True))
    loss_B2A_fake = fp32(D_A.get_output_for(fake_feat_A, labels_A, is_training=True))
